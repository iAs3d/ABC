                                ...
                                <div class="card-body">
                                    ...
                                    <input type="hidden" name="id" value="{{$book_data->id}}">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="title" placeholder="Enter product title" name="title" value="{{$book_data->title}}">
                                            <span class="text-danger">@error('title'){{$message}}@enderror</span>
                                        </div>
                                        <div class="form-group">
                                            <label for="author">Seller</label>
                                            <input type="text" class="form-control" id="author" placeholder="Enter Seller Name" name="author" value="{{$book_data->author}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="5" id="description" placeholder="Enter the product description" name="description" value="{{$book_data->description}}"></textarea>

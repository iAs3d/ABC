    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Product Registration</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
        ...
        <form action="{{url('admin/register-book')}}" method="post">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="author" placeholder="Enter Seller Name" name="author">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="5" id="description" placeholder="Enter the product description" name="description"></textarea>

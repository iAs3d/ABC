...
Route::prefix('admin')->group(function () {
    Route::middleware(['auth:user', CheckAdminMiddleware::class])->group(function () {
        ...
        Route::get('/new-product',[BooksController::class,'register_book_page']);
        Route::post('/register-book',[BooksController::class,'register_book']);
        Route::get('/show-products',[BooksController::class,'show_books']);
...
Route::prefix('user')->group(function () {
    Route::middleware('auth:user')->group(function () {
        ...
        Route::get('produtc-desc/{id}', [UserController::class, 'book_desc']);
